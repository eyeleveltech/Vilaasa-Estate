...
export const PartnerLayout: React.FC = () => {
  ...
  const getPageTitle = () => {
    ...
    if (path === "/partner/inventory") return "Luxury Portfolio Inventory";
    if (path === "/partner/leads") return "Registered Client Pipeline";
    if (path === "/partner/site-visits") return "Private Site Inspections";
    return "Partner Concierge Dashboard";
  };
        ...
        <div className="border-t border-border p-3 space-y-2.5">
          ...
          <div className="flex items-center justify-between rounded-lg bg-secondary/50 p-2.5 border border-border">
            <div className="flex items-center space-x-2.5 overflow-hidden">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-emerald-500/10 text-xs font-bold text-emerald-400 border border-emerald-500/30">
